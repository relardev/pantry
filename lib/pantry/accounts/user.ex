defmodule Pantry.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Pantry.Repo)
  ...
  """
  def valid_password?(%Pantry.Accounts.User{hashed_password: hashed_password}, password)
